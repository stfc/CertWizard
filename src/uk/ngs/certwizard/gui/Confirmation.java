...
public class Confirmation extends javax.swing.JFrame {
    ...
    public Confirmation(String action, String message, Certificate cert) {
        initComponents();
        URL iconURL = Confirmation.class.getResource("/uk/ngs/ca/images/ngs-icon.png");
        if(iconURL != null){
        ...
        this.dn.setText(cert.getDN());
        this.email.setText(cert.getEmail());
        this.vFrom.setText(cert.getVFrom());
        this.vTo.setText(cert.getVTo());
        this.status.setText(cert.getStatus());
        ...
        else if(cert.getStatus().equals("Expired")){
            this.status.setForeground(new ExpiredCertColor());
        }

        else if(cert.getStatus().equals("Renewal Due")){
            this.status.setForeground(new RenewalDueColor());
        }
        else if(cert.getStatus().equals("Valid")){
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        if (action.equals("Renew")){
            JOptionPane.showMessageDialog(this, "The renewal request has been submitted", 
                    "Renewal request successful",JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        }

        if (action.equals("Revoke")){
            JOptionPane.showMessageDialog(this, "Your certificate has now been revoked."
                    ,"Certificate revoked", JOptionPane.INFORMATION_MESSAGE);
            
            this.dispose();
        }
        if (action.equals("Remove")){
            JOptionPane.showMessageDialog(this, "The certificate has now been removed from the Certificate Manager",
