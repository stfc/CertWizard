 ...
 * @author xw75
 */
public class CSRDelete {

    private String encodedPublicKey = null;
    private long req_id = -1;
    private String DELETEURL = SysProperty.getValue("uk.ngs.ca.request.csr.reqid.url");
    private String USERAGENT = SysProperty.getValue("uk.ngs.ca.request.useragent");
    private PrivateKey privateKey;

    public CSRDelete(PrivateKey privateKey, String encodedPublicKeyString, long req_id) {
    ...
    public boolean isSuccessDelete() {
        String deleteURL = this.DELETEURL + "/" + this.req_id;
