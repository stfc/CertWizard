...
/**
 * Ths icalss calls CA server through http URI: /CSR/<req_id>/useremail
 * @author xw75
 */
public class CSREmail {
    ...
    public CSREmail(String reqID) {
        try {
            String csrURL = SysProperty.getValue("uk.ngs.ca.request.csr.email.url");
            csrURL = csrURL + "/" + reqID;
            csrURL = csrURL + "/" + "useremail";
